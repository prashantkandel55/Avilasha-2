...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // For MVP, we'll simulate authentication with mock data
      ...
      if (email === 'demo@example.com' && password === 'password') {
        ...
        localStorage.setItem('avilasha_user', JSON.stringify(mockUser));
        localStorage.setItem('avilasha_session', JSON.stringify(mockSession));
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-gray-900 py-12 px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            <h2 className="mt-4 text-3xl font-bold text-white">Welcome to <span className="text-green-500">Avilasha</span></h2>
            <p className="mt-2 text-sm text-gray-400">
              Login to access your account and start earning points!
            </p>
          </div>
          ...
          <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="text-center pt-2">
              <p className="text-xs text-green-500">
                Complete your profile to earn 20 more points
              </p>
            </div>
